...
const CourseDetails = () => {
    ...
    const { name, category, details, image, rating, reviews, price, short_description, topics_cover } = coursesDetails;

    const topic = topics_cover[1].topics;
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="mx-auto sm:text-center lg:max-w-2xl">
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    ...
                    <p className='mt-10 bg-yellow-500 text-lg font-bold py-4 cursor-pointer hover:bg-yellow-200'>Download Course Details In PDF </p>
                </div>
